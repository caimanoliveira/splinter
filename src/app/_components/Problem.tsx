    ...
    <section className="bg-[#0f172a] text-white px-4 py-20" aria-label="Por que profissionais qualificados travam nas decisões de carreira">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-5 text-[#94a3b8] text-lg leading-relaxed">
          ...
          <p>
            Essas são as variáveis visíveis. E elas são importantes. Mas{" "}
            <strong className="text-white">não são o que vai determinar se você vai ser feliz
            ou arrependido em 18 meses.</strong>
          </p>
          <p>
            As variáveis que realmente determinam isso são: o quanto você vai aprender nos próximos
